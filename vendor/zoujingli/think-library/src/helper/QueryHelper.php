...
class QueryHelper extends Helper
{
     ...
     * @return $this
     */
    public function equaladd($key, $val)
    {
     ...
     * @return $this
     */
    public function innew($fields, $split = ',')
    {
        $this->query->whereIn($fields,$split);
        return $this;
    }
     ...
     * @throws \think\exception\PDOException
     */
    public function pagenew($page = true, $display = true, $total = false, $limit = 0)
    {
        return PageHelper::instance()->initnew($this->query, $page, $display, $total, $limit);
    }
}